...
public class Pit extends Screen {
    public Pit(IDisplay iDisplay) {
        super(iDisplay, "Pit");
        super.env.getConfigs().add(new Config("Tire Select", 2,0));
        super.env.getActions().add(new Action("Pit in for in garage."));
    }
    @Override
